...
export function AuthLayout({ children, title, subtitle }: AuthLayoutProps) {
  return (
    <div className="min-h-screen flex">
      ...
      >
        <div>
          <div className="bg-white rounded-2xl px-4 py-2 mb-8">
            <img src="/logo.png" alt="First Whistle" className="w-full h-auto max-h-16 object-contain" />
          </div>
      ...
      <div className="flex-1 flex items-center justify-center p-6 bg-gray-50">
        <div className="w-full max-w-sm">
          <div className="mb-8 lg:hidden">
            <img src="/logo.png" alt="First Whistle" className="h-16 w-auto mx-auto object-contain" />
          </div>
