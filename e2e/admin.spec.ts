...
test('@admin-smoke admin can create a new team and it appears in the teams list', async ({ asAdmin }) => {
...
test('@admin-smoke admin can open the Add Player form on the Roster tab', async ({ asAdmin }) => {
  const { page, admin } = asAdmin;
